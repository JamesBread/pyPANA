...
class PANAMessage:
    ...
    def get_encryption_algorithm(self):
        ...
        Returns:
            int: Algorithm ID or None if not present
        """
    ...
    def apply_encryption(self, crypto_context):
        ...
        Args:
            crypto_context: CryptoContext with encryption key
    ...
    def decrypt_avps(self, crypto_context):
        ...
        Args:
            crypto_context: CryptoContext with decryption key
...
class EncryptedAVPSet:
    ...
    def add_avps(self, avp_list):
        ...
        Args:
            avp_list: List of AVP instances to encrypt
        """
        for avp in avp_list:
            self.add_avp(avp)
    ...
    def create_encryption_encap_avp(self):
        ...
        Returns:
            AVP: Encryption-Encap AVP with encrypted content
            
        Raises:
            ValueError: If no AVPs to encrypt or data too large
        """
    ...
    def decrypt_encryption_encap_avp(self, encap_avp):
        ...
        Args:
            encap_avp: Encryption-Encap AVP containing encrypted AVPs
            
        Returns:
            list: List of decrypted AVP instances
        """
